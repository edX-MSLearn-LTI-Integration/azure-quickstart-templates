...
sudo curl -L "https://raw.githubusercontent.com/edX-MSLearn-LTI-Integration/azure-quickstart-templates/master/application-workloads/opendx/openedx-tutor-lilac-ubuntu/script/deploy_tutor.sh" -o ./deploy_tutor.sh
