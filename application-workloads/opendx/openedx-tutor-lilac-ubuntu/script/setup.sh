...
sudo curl -L "https://raw.githubusercontent.com/edX-MSLearn-LTI-Integration/application-workloads/opendx/openedx-tutor-lilac-ubuntu/script/deploy_tutor.sh" -o ./deploy_tutor.sh
